...
def userInput(): #EXTRA CREDIT User input tool that will extract airport and operation type data depending on user request
    #print instructions
...
if __name__ == "__main__": #initialize main function
    ...
    MainFrame.to_csv('AirportMainFrame')
